...
public class TestChannelController {
	...
	public void doInsert() throws Exception {
		...
		MockHttpServletRequestBuilder createMessage = MockMvcRequestBuilders.post("/channel/doInsert.do")
				.param("chLink", channelVO.getChLink()).param("wsLink", channelVO.getWsLink())
				.param("chName", channelVO.getChName()).param("topic", channelVO.getTopic())
				.param("chDescription", channelVO.getChDescription()).param("chAccess", channelVO.getChAccess())
	...
	public void doDelete() throws Exception {
		...
		MockHttpServletRequestBuilder createMessage = MockMvcRequestBuilders.post("/channel/doDelete.do")
	...
	public void doSelectOne() throws Exception {
		...
		MockHttpServletRequestBuilder createMessage = MockMvcRequestBuilders.get("/channel/doSelectOne.do")
				.param("chLink", channelVO.getChLink());
	...
	public void doSelectList() throws Exception {
		...
		MockHttpServletRequestBuilder createMessage = MockMvcRequestBuilders.get("/channel/doSelectList.do")
