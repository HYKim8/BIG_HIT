...
public class TestSaveController {
	final static Logger LOG = LoggerFactory.getLogger(TestSaveController.class);
	@Autowired
	...
	public void test() throws Exception {
		...
		MockHttpServletRequestBuilder createMessage =
				MockMvcRequestBuilders.get("/save/doSelectList.do")
	...
	@Test
	public void bean() {
		assertThat(saveThrService,is(notNullValue()));
