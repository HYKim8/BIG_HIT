  ...
  <div style="margin:10px;">	
    ...
    <div class="tab-content">	
      ...
      <div class="tab-pane fade in active" id="wsLK">
        <h1>워크스페이스 링크 입력</h1>
      	<input type="text" class="form-control" name="wsLink" id="wsLink" placeholder="워크스페이스 링크" />
      	<input type="button" value="계속" id="wsLink_btn" class="btn btn-primary btn-lg btn-block" />	
      </div>
      
      <div class="tab-pane fade" id="wsNM">
        <h1>워크스페이스 이름 입력</h1>
      	<input type="text" class="form-control" name="wsName" id="wsName" placeholder="워크스페이스 이름" />
      ...
      <div class="tab-pane fade" id="pjNM">
        <h1>프로젝트명 입력</h1>
      	<input type="text" class="form-control" name="project" id="project" placeholder="프로젝트명" />
      ...
      <div class="tab-pane fade" id="addT">
        <h1>추가하고 싶은 팀원 메일 입력</h1>
      	<input type="text" class="form-control" name="email" id="email" placeholder="팀원 email" />
